...
async def get_metadata():
    ...
    async with async_playwright() as p:
        ...
        await page.goto("https://www.idee.es/csw-inspire-idee/srv/spa/catalog.search#/search?facet.q=topicCat%2FinlandWaters")
        while True:
            index += 1
...
def write_links_to_file(links):
    with open("es_metadata_links.txt", "w") as f:
